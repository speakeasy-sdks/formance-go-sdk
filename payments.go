...
func (s *payments) ConnectorsStripeTransfer(ctx context.Context, request operations.ConnectorsStripeTransferRequest) (*operations.ConnectorsStripeTransferResponse, error) {
	baseURL := s.serverURL
